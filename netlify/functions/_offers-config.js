...
const OFFERS = {
  ...
  PACK_PRIMAIRE_3H: {
    ...
    label: 'Accompagnement Progression — Primaire à 5e — 3h/semaine — 7 semaines',
  ...
  PACK_PRIMAIRE_4H: {
    ...
    label: 'Accompagnement Progression — Primaire à 5e — 4h/semaine — 7 semaines',
    cycleScolaire: 'primaire_6e',
    heuresSemaine: 4,
    volumeHeures: 28,
    tarifHoraire: 20,
  ...
  PACK_PRIMAIRE_4H30: {
    ...
    label: 'Accompagnement Progression — Primaire à 5e — 4h30/semaine — 7 semaines',
    cycleScolaire: 'primaire_6e',
    heuresSemaine: 4.5,
    volumeHeures: 31.5,
    tarifHoraire: 20,
